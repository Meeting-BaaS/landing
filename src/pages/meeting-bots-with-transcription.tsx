    ...
    return (
        <main className="snap-mandatory">
            ...
            <div className=" overflow-y-scroll snap-mandatory snap-y h-screen min-h-screen min-w-screen max-w-screen overflow-x-hidden bg-neutral-50">
                <Navbar />
                <WelcomeSection
                    title1="Meeting Bots" // Updated title1
                    title2="with Transcription." // Updated title2
                    title3="as a Service." // Updated title3
                    subtitle1="Bridge the gap between" // Updated subtitle1
                    subtitle2="video meetings and LLMs using one API." // Updated subtitle2
